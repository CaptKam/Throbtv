    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <div className="text-muted-foreground">Establishing connection to Throb<span style={{ color: '#ef4444' }}>.TV</span></div>
        </div>
      </div>
    );
  }
        ...
        <div className="sticky top-0 z-20 bg-background/95 backdrop-blur-xl border-b border-white/5 pt-safe">
          <div className="px-4 py-3 flex items-center gap-3">
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span className="text-lg font-black tracking-tighter">Throb<span style={{ color: '#ef4444' }}>.TV</span></span>
            </div>

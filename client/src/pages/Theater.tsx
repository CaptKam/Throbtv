        ...
        {quickFade && (
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-4xl font-black tracking-tighter">throb<span className="text-muted-foreground">.</span><span className="text-primary">tv</span></span>
            </div>
      ...
      {!currentVideo && (
        <div className="flex flex-col items-center justify-center gap-8 p-8 max-w-lg text-center">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-3xl font-black tracking-tighter">throb<span className="text-muted-foreground">.</span><span className="text-primary">tv</span></span>
          </div>
